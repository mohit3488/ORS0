							...
							<div class="row">
								<div class="col-6">
									<button type="submit"
										...
										name="operation" name="operation" value="Search">
										<b><s:message code="label.search"></s:message></b>
									</button>
								</div>
								<div class="col-6">
									<button type="submit"
										class="btn btn-warning btn-block btn-round w-100"
										name="operation" name="operation" value="Reset">
										<b><s:message code="label.reset"></s:message></b>
									</button>
								</div>
							</div>
						</div>
								...
								<thead style="background-color: #ff9800a3;">
									<tr>
										<th scope="col" class="text-center text-white"
											style="color: white;"><input type="checkbox"
											id="select_all" /></th>
										...
										<th scope="col" class="text-center"
											style="width: 10%; color: white;"><s:message
												code="label.edit" /></th>
									</tr>
								</thead>
									...
									<c:forEach items="${list}" var="role" varStatus="ct">
										<tr>
											<td class="text-center"><input class="checkbox"
												name="chk_1" type="checkbox" value="${role.id}"></td>
					...
					<div class="row d-flex justify-content-center">
							...
							<c:choose>
								<c:when test="${form.pageNo > 1}">
									<button type="submit"
										...
										name="operation" name="operation" value="Previous">
								...
								<c:otherwise>
									<button type="submit"
										...
										name="operation" name="operation" value="Previous" disabled>
										<i class="fa fa-arrow-circle-left" aria-hidden="true"></i>
									</button>
								</c:otherwise>
							</c:choose>
						...
						<div class="col-lg-1 col-3">
							<button type="submit"
								...
								name="operation" name="operation" value="New">
						...
						<div class="col-lg-1 col-3">
							<button type="submit"
								...
								name="operation" name="operation" value="Delete">
						...
						<div class="col-lg-1 col-3">
							<c:choose>
								<c:when test="${nextlistsize != 0}">
									<button type="submit"
										class="btn btn-outline-primary btn-block btn-round w-100"
										name="operation" name="operation" value="Next">
								...
								<c:otherwise>
									<button type="submit"
										class="btn btn-outline-secondary btn-block btn-round w-100"
										name="operation" name="operation" value="Next" disabled>
										<i class="fa fa-arrow-circle-right" aria-hidden="true"></i>
									</button>
								</c:otherwise>
							</c:choose>
				...
				<c:if test="${empty list}">
					<div class="row d-flex justify-content-center">
						<div class="col-lg-2 col-6">
							<button type="submit"
								class="btn btn-outline-warning btn-block btn-round w-100"
								name="operation" name="operation" value="Back">
