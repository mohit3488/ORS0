								...
								<table border="2" width="100%" cellpadding=8px cellspacing=".3"
									...
									<thead style="background-color: #ff9800a3;">
										<tr>
											...
											<th scope="col" class="text-center" style="color: white;"><s:message code="label.gender"/></th>
										...
										<c:forEach items="${list}" var="student" varStatus="ct">
											<tr>
												...
												<td class="text-center"><fmt:formatDate
														pattern="dd/MM/yyyy" value="${student.dob}" /></td>
												...
												<td class="text-center"><c:url var="editUrl"
													...
													name="operation" href="${editUrl}${student.id}"><i
