				...
				<div class="card" align="center">
					<article class="card-body">
						<c:choose>
							<c:when test="${form.id==0}">
								<h4 class="card-title text-center mb-4 mt-1"
									style="color: #fff;">
									<u><s:message code="label.addmarksheet" /></u>
								</h4>
							</c:when>
							<c:otherwise>
								<h4 class="card-title text-center mb-4 mt-1"
									style="color: #fff;">
									<u><s:message code="label.updatemarksheet"></s:message></u>
								</h4>
							</c:otherwise>
						</c:choose>
						...
						<div class="form-group">
							...
							<div align="left">
								<font style="color: red"><sf:errors path="rollNo" /></font>
							</div>
						...
						<div class="form-group">
							...
							<div align="left">
								<font style="color: red"><sf:errors path="studentId" /></font>
							</div>
						...
						<div class="form-group">
							...
							<div class="input-group">
								<div class="input-group-prepend">
									<span class="input-group-text"> <i class="fas fa-star"></i></i>
									</span>
								</div>
							...
							<div align="left">
								<font style="color: red"><sf:errors path="physics" /> </font>
							</div>
						...
						<div class="form-group">
							...
							<div align="left">
								<font style="color: red"><sf:errors path="chemistry" /></font>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="input-group">
								<div class="input-group-prepend">
									<span class="input-group-text"> <i class='fas fa-star'></i>
									</span>
								</div>
								<sf:label path="maths">
