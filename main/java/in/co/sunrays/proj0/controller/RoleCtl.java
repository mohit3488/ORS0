...
public class RoleCtl extends BaseCtl{
    ...
    public String submit(@RequestParam(required = false) Long id,@ModelAttribute("form") RoleForm form,BindingResult result,Model model,Locale locale) throws DuplicateRecordException
    {
    	String enterName = messageSource.getMessage("label.entername", null, locale);
    	model.addAttribute("enterName",enterName);
    	...
    	if(OP_SAVE.equalsIgnoreCase(form.getOperation()))
    	{
    		...
    		if(id>0) {
    			...
    			try {
    				...
    				String msg = messageSource.getMessage("message.rolename", null,locale);
    ...
    public String display(@ModelAttribute("form") RoleForm form , Model model,Locale locale) {
		...
		List next = service.search(new RoleDTO(), form.getPageNo()+1, form.getPageSize());
