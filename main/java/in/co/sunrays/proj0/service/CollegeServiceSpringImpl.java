...
public class CollegeServiceSpringImpl implements CollegeServiceInt {
	 ...
	 * 
	 * @see
	 * in.co.sunrays.proj0.service.CollegeServiceInt#add(in.co.sunrays.proj0.dto.
	 * CollegeDTO)
	 */
	 ...
	 * 
	 * @see
	 * in.co.sunrays.proj0.service.CollegeServiceInt#update(in.co.sunrays.proj0.dto.
	 * CollegeDTO)
	 */
	@Transactional(propagation = Propagation.REQUIRES_NEW, readOnly = false)
	 ...
	 * 
	 * @see
	 * in.co.sunrays.proj0.service.CollegeServiceInt#findByName(java.lang.String)
	 */
	 ...
	 * 
	 * @see
	 * in.co.sunrays.proj0.service.CollegeServiceInt#search(in.co.sunrays.proj0.dto.
	 * CollegeDTO, int, int)
	 */
	@Transactional(readOnly = true)
