...
public class LoginCtl extends BaseCtl {
	...
	public String Submit(@ModelAttribute("form") @Valid LoginForm form, BindingResult result, Model model,
	...
	public String submit(@ModelAttribute("form") @Valid ForgetPasswordForm form, BindingResult result, Model model,
			Locale locale) {
