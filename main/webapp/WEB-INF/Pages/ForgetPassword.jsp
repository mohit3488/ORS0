				...
				<div class="card">
					<article class="card-body">
						...
						<h4 class="card-title text-center mb-4 mt-1" style="color: #fff;">
							<u><s:message code="label.forgetpassword"></s:message></u>
						</h4>

						<lable style="color: #fff;">
						<u><s:message code="label.forgetpassword1"></s:message></u></lable>
						<br>
						<br>
						...
						<button type="submit" name="operation" value="Go"
							class="btn btn-outline-warning btn-block button2">
