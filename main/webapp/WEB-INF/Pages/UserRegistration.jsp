				...
				<div class="card" align="center">
					<article class="card-body">
						<h4 class="card-title text-center mb-4 mt-1" style="color: #fff;">
							<u><s:message code="label.userRegistration"></s:message> </u>
						</h4>
						...
						<button type="submit" name="operation"
							style="float: left; width: 70px; margin-left: 40px;"
							value="SignUp" class="btn btn-info btn-block button2 msgBtn">
							<s:message code="label.signup" />
						</button>

						<button type="submit" name="operation"
							style="width: 60px; margin-left: 100px;" value="reset"
