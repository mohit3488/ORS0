					...
					<article class="card-body">
						...
						<c:choose>
							<c:when test="${form.id==0}">
								<h4 style="color: #fff;">
									<u><s:message code="label.myprofile" /></u>
								</h4>
							</c:when>
							<c:otherwise>
								<h4 style="color: #fff;">
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<sf:label path="firstName">
									<c:set var="firstNameErrors"></c:set>
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<sf:label path="lastName">
									<c:set var="lastNameErrors"></c:set>
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<sf:label path="mobileNo">
									<c:set var="mobileNoErrors"></c:set>
						...
						<div class="row">
							...
							<div class="clo-sm-6">
								<button type="submit" name="operation"
									style="width: 150px; margin-left: 22px;" value="ChangePassword"
