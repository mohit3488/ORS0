				...
				<div class="card" align="center">
					<article class="card-body">
						...
						<c:choose>
							<c:when test="${form.id==0}">
								<h4 class="card-title text-center mb-4 mt-1"
									style="color: #fff;">
									<u><s:message code="label.addstudent" /></u>
								</h4>
							</c:when>
							<c:otherwise>
								<h4 class="card-title text-center mb-4 mt-1"
									style="color: #fff;">
									<u><s:message code="label.updatestudent"></s:message></u>
								</h4>
							</c:otherwise>
						</c:choose>
						...
						<div class="form-group">
							...
							<div align="left">
								<font style="color: red"><sf:errors path="firstName" />
								</font>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div align="left">
								<font style="color: red"><sf:errors path="email" /> </font>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div align="left">
								<font style="color: red"><sf:errors path="collegeId" />
								</font>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<sf:input path="dob" class="form-control" id="date"
									readonly="readonly" placeholder="${enterdob}"
									autocomplete="off" />
							</div>
							<div align="left">
						...
						<div class="form-group">
							...
							<div align="left">
								<font style="color: red"><sf:errors path="mobileNo" /> </font>
							</div>
						</div>
