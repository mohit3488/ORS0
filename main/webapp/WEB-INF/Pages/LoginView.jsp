...
<body>
	<sf:form method="post" modelAttribute="form">
		...
		<div class="container-fluid" align="center">
			...
			<aside class="col-sm-4"> <!-- <div class="card" style="background-color: rgb(255,255,255);opacity: 0.7;"> -->
			<div class="card">
				<article class="card-body"> <a
					href="<c:url value="/Registration"></c:url>"
					class="float-right btn btn-info"><s:message code="label.signup"></s:message></a>

				<h3 class="card-title text-center mb-4 mt-1" style="color: #fff;">
					<u><s:message code="label.login"></s:message>:</u>
				</h3>
				...
				<button type="submit" name="operation" value="SignIn"
					class="btn btn-primary btn-block button2" title="this is for login">
				...
				<p class="text-center">
					<a href="<c:url value="ForgotPassword"/>" class="btn"
						style="color: white" title="this is for recover password"><u><s:message
								code="label.forgetpassword" />?</u></a>
				</p>
			</div>
