				...
				<div class="card" align="center">
					<article class="card-body">
						...
						<c:choose>
							<c:when test="${form.id==0}">
								<h4 class="card-title text-center mb-4 mt-1"
									style="color: #fff;">
									<u><s:message code="label.addrole" /></u>
								</h4>
							</c:when>
							<c:otherwise>
								<h4 class="card-title text-center mb-4 mt-1"
									style="color: #fff;">
									<u><s:message code="label.updaterole"></s:message></u>
								</h4>
							</c:otherwise>
						</c:choose>
						...
						<div class="form-group">
							...
							<div align="left">
								<font style="color: red"><sf:errors path="name" /> </font>
							</div>
						</div>
						...
						<div class="form-group">
							...
							<div class="input-group">
								...
								<sf:label path="description">
									<c:set var="descriptionErrors"></c:set>
							...
							<div align="left">
								<font style="color: red"><sf:errors path="description" /></font>
							</div>
						</div>
